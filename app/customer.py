...
class Customer:
    ...
    def update_money(self, shopping_cost: float, travel_cost: float) -> float:
        self.money -= (shopping_cost + travel_cost)
        return self.money
